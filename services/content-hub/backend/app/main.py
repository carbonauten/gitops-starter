...
from .routes import ai, articles, audit, auth, certificates, dashboard, departments, files, health, integrations, monitor, publish, search, sync, user, versions, workflow
